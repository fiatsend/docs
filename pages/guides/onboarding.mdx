...
## Onboarding and making a transaction with offramps (A fiatsend native Dapp)
...
If the FSNFT does not exist, you will be required to create an account and sent to the onboarding page.
![Create a Fiatsend Account](/onboarding/step-0.png)
